(function () {
    ...
    if (localStorage.spruhartl) {
        ...
        document.querySelector("#style")?.setAttribute("href", "https://www.spruko.com/demo/spruha/dist/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
    }
    ...
    function localStorageBackup() {
        ...
        if (localStorage.spruhartl) {
            let html = document.querySelector('html');
            html.setAttribute('dir', 'rtl');
            document.querySelector('#style').href = 'https://www.spruko.com/demo/spruha/dist/assets/libs/bootstrap/css/bootstrap.rtl.min.css'
            setTimeout(() => {
                rtlFn();
            }, 1000);
        }
